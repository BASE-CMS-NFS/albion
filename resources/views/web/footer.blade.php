            ...
            <div class="container">
              <div class="row">
                <div class="col-12 col-lg-4 mb-3"><a href="#"><img class="d-inline-block align-middle" src="{{url('assets/images/logo.jpg')}}" alt="" width="30" />
                  ...
                  <p class="my-3"> <span class="fw-medium">HARAKIRI ALBION </span>ALBION MANAGEMENT SYSTEM<br /></p>
                  ...
                  <p class="text-400 my-3">&copy; {{date('Y')}} HARAKIRI</p>
                </div>
                <div class="col-6 col-sm-4 col-lg-3 mb-3">
                  <h5 class="lh-lg">product </h5>
                  <ul class="list-unstyled mb-md-4 mb-lg-0">
                    <li class="lh-lg"><a class="text-900 text-decoration-none" href="https://kodeshop.id/">Kodeshop.id</a></li>
                  </ul>
                </div>
                <div class="col-6 col-sm-4 col-lg-3 mb-3">
