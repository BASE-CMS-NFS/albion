    ...
    <div class="col-sm-12 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          ...
          <form class="forms-sample" method="POST" action="{{url('ganking_detail/update')}}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group mt-20">
              <a class="btn btn-success" href="{{url('ganking_detail')}}"><i class="mdi mdi-arrow-left-thick"></i>&nbsp;Back</a>
